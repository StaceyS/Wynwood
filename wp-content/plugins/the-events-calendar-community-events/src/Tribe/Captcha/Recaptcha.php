...
class Tribe__Events__Community__Captcha__Recaptcha
	...
	protected function public_key() {
		return Tribe__Events__Community__Main::instance()->getOption( 'recaptchaPublicKey', '' );
	}

	protected function private_key() {
		return Tribe__Events__Community__Main::instance()->getOption( 'recaptchaPrivateKey', '' );
	}
	 ...
	 */
	public function check_answer( $privkey, $remoteip, $challenge, $response, $extra_params = array() ) {
