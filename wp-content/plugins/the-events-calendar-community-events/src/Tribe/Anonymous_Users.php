...
class Tribe__Events__Community__Anonymous_Users {
	...
	protected function allow_venue_organizer_submissions() {
		add_action( 'tribe_events_community_form', array( $this, 'add_venue_org_caps' ) );
		add_action( 'tribe_ce_before_event_submission_page', array( $this, 'add_venue_org_caps' ) );
	}
	...
	public function add_venue_org_caps() {
		add_filter( 'user_has_cap', array( $this, 'filter_venue_org_caps' ), 10, 3 );
	}
	...
	protected function allow_tribe_event_validation() {
		add_action( 'wp_ajax_nopriv_tribe_event_validation', array(
